...
import { rotateZeroToBearing, type RotatedHeadingReading } from '@/data/streams/compass/rotateZeroToBearing';
...
export function useBearingAlignment() {
  ...
  const ensureSubscription = () => {
    if (sub || !alignmentActive.value) return;
